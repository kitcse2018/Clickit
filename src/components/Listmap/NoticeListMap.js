        ...
        <li className={"notice-list-li"}>
            ...
            <div className={"notice-list-btn"}>
                <Button className={"notice-list-edit"} color={"primary"} onClick={()=>{history.push({
                    ...
                    state: {
                        notice_num: props.notice_num,
                        notice_title: props.notice_title,
                        notice_contents: props.notice_contents,
                    }
                })}}>수정</Button>
                <Button className={"notice-list-delete"} color={"danger"} onClick={e=>{}}>삭제</Button>
            </div>
        </li>
      </>
    );
